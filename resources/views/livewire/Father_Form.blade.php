    ...
    <div style="display: none" class="row setup-content" id="step-1">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                @if($updateMode)
                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right  pl-5 pr-5 pt-2 pb-2" wire:click="firstStepSubmit_edit"
                        type="button">{{trans('Parent_trans.Next')}}
                </button>
            @else
                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right  pl-5 pr-5 pt-2 pb-2" wire:click="firstStepSubmit"
                        type="button">{{trans('Parent_trans.Next')}}
                </button>
            @endif
