            ...
            <div style="display: none" class="row setup-content" id="step-3">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <button class="btn btn-danger btn-sm nextBtn btn-lg pull-right pl-5 pr-5 pt-2 pb-2  ml-3 mr-3" type="button"
                                wire:click="back(2)">{{ trans('Parent_trans.Back') }}</button>
                        <button class="btn btn-success btn-sm btn-lg pull-right pl-5 pr-5 pt-2 pb-2  ml-3 mr-3" wire:click="submitForm"
