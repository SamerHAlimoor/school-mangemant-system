...
@section('css')
    @toastr_css
@section('title')
{{ trans('Fees_trans.add_new_invoices') }}@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{ trans('Fees_trans.add_new_invoices')}}  --> {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                    ...
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name" class="mr-sm-2">{{ trans('Fees_trans.name') }}</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('Fees_trans.fee_type') }}</label>
                                                    <div class="box">
                                                        <select class="fancyselect" name="fee_id" required>
                                                            <option value="">{{ trans('Fees_trans.fee_type') }}</option>
                                                            @foreach($fees as $fee)
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('Fees_trans.ammount') }}</label>
                                                    <div class="box">
                                                        <select class="fancyselect" name="amount" required>
                                                            <option value="">{{ trans('Fees_trans.ammount') }}</option>
                                                            @foreach($fees as $fee)
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2">{{ trans('Fees_trans.details') }}</label>
                                                    <div class="box">
