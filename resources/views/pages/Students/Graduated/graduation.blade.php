<div class="modal fade" id="graduation_student{{$Student->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p> {{ trans('Students_trans.is_gardauation').$Student->name  }} </p>
